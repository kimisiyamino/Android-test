...
public class FamiliarActivity extends AppCompatActivity {
    ...
    public void way_familiar(View view){
        Intent intent = new Intent(FamiliarActivity.this, Familiar2Activity.class);
    ...
    public void way_away(View view){
        Intent intent = new Intent(FamiliarActivity.this, ToHomeActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
